...
class ModernThemeManager:
    ...
    def __init__(self, root):
        ...
        self.colors = {
            ...
            'card_bg': '#FCFCFC',         # Very light gray for card backgrounds
    ...
    def _configure_frames(self):
        ...
        # Form section card frame 
        self.style.configure('FormCard.TFrame',
                             background=self.colors['card_bg'],
                             relief='solid',
                             borderwidth=1,
                             bordercolor=self.colors['border'])
        ...
        # Card-style LabelFrame with lighter background
    ...
    def _configure_labels(self):
        ...
        self.style.configure('TLabel',
                             ...
                             width=15)  # Prevent clipping with min width
        ...
        self.style.configure('Header.TLabel',
                             ...
                             width=18)  # Wider for headers to prevent clipping
        ...
        self.style.configure('Card.Subheader.TLabel',
                             background=self.colors['card_bg'],
                             foreground=self.colors['text'],
                             font=self.fonts['subheader'])
        ...
        # Card Small label
        self.style.configure('Card.Small.TLabel',
                             background=self.colors['card_bg'],
                             foreground=self.colors['text_secondary'],
                             font=self.fonts['small'])
    ...
    def _configure_notebook(self):
        ...
        # Create a clean, flat tab design with bottom border
        ...
        # Add a subtle separator at the bottom of the tab bar
        self.style.configure('TNotebook.Tab',
                             font=self.fonts['normal'],
                             background=self.colors['bg'],
                             foreground=self.colors['text'],
                             borderwidth=0,
                             padding=(20, 10, 20, 8))  # Adjust vertical alignment
    ...
    def _configure_separator(self):
        ...
        # Tab separator (for under tabs)
        self.style.configure('Tab.TSeparator',
                             background=self.colors['border'])
